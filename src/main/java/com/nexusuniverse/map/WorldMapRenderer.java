    ...
    private void drawTerrain(MapCanvas canvas, TerrainCache cache, int centerCellX, int centerCellZ) {
        for (int x = 0; x < 128; x++) {
            for (int z = 0; z < 128; z++) {
                ...
                // MapCanvas#setPixelColor takes java.awt.Color, not org.bukkit.Color, despite
                // every other colour-related API on this plugin (TerrainCache, PointOfInterest)
                // correctly using org.bukkit.Color -- this is the one conversion point for that.
